...
public class MemberMypageController {
	...
	public String  memberInfoModifyPro(MemberCommand memberCommand,
	...
	public String  memberPwForm1(@RequestParam(value = "userPw") 
		String userPw, Model model, HttpSession session) throws Exception{
	...
	public String  pwModifyPro(
			@Validated ChangePwdCommand changePwdCommand,
